...
import com.guardian.gameserver.network.serverpackets.GameGuardQuery;
...
public class nProtect
{
	...
	private nProtect()
	{
		...
		try
		{
			clazz = Class.forName("com.guardian.protection.main");
		...
		{
			if (Config.DEBUG)
				LOGGER.warn("nProtect System will be not loaded due to ClassNotFoundException of 'com.guardian.protection.main' class");
		}
