...
public class FService
{
	...
	public static final String L2JGUARDIAN_CONFIG_FILE = "./config/functions/l2jguardian.properties";
	...
	public static final String VOTE_SYSTEM_GLOBAL_FILES = "./config/functions/votesystemglobal.properties";
	...
	public static final String L2GUARDIAN_CONFIG_FILE = "./config/guardian/guardian.properties";
	public static final String EVENT_CTF_FILE = "./config/guardian/ctf.properties";
	public static final String EVENT_DM_FILE = "./config/guardian/dm.properties";
	public static final String EVENT_TVT_FILE = "./config/guardian/tvt.properties";
	public static final String EVENT_TW_FILE = "./config/guardian/tw.properties";
	public static final String IRC_FILE = "./config/guardian/irc.properties";
	public static final String EVENT_ARENA_FILE = "./config/guardian/arena.properties";
	...
	// version
	public static final String SERVER_VERSION_FILE = "./config/version/l2jguardian-server.properties";
	public static final String DATAPACK_VERSION_FILE = "./config/version/l2jguardian-datapack.properties";
