...
public class Repair implements IVoicedCommandHandler, ICustomByPassHandler
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.handler.ICustomByPassHandler#handleCommand(java.lang.String, com.guardian.gameserver.model.actor.instance.L2PcInstance, java.lang.String)
	 */
	@Override
