...
public class AwayCmd implements IVoicedCommandHandler
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.handler.IVoicedCommandHandler#useVoicedCommand(String, com.guardian.gameserver.model.L2PcInstance), String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.handler.IVoicedCommandHandler#getVoicedCommandList()
	 */
