...
import com.guardian.gameserver.communitybbs.Manager.AdminBBSManager;
...
public class AdminBBS implements IAdminCommandHandler
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.handler.IAdminCommandHandler#useAdminCommand (java.lang.String, com.guardian.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.handler.IAdminCommandHandler#getAdminCommandList()
	 */
	@Override
