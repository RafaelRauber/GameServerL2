...
public final class TaskRestart extends Task
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.tasks.Task#getName()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.tasks.Task#onTimeElapsed(com.guardian.gameserver.tasks.TaskManager.ExecutedTask)
	 */
	@Override
