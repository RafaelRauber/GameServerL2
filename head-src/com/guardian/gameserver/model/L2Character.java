 ...
 */
package com.guardian.gameserver.model;

import static com.guardian.gameserver.ai.CtrlIntention.AI_INTENTION_ATTACK;
import static com.guardian.gameserver.ai.CtrlIntention.AI_INTENTION_FOLLOW;
...
import com.guardian.gameserver.ai.L2AttackableAI;
...
import com.guardian.gameserver.datatables.csv.MapRegionTable.TeleportWhereType;
import com.guardian.gameserver.datatables.sql.NpcTable;
import com.guardian.gameserver.geo.GeoData;
import com.guardian.gameserver.geo.pathfinding.Node;
import com.guardian.gameserver.geo.pathfinding.PathFinding;
import com.guardian.gameserver.handler.ISkillHandler;
import com.guardian.gameserver.handler.SkillHandler;
import com.guardian.gameserver.handler.itemhandlers.Potions;
...
import com.guardian.gameserver.model.actor.instance.L2BoatInstance;
import com.guardian.gameserver.model.actor.instance.L2ControlTowerInstance;
...
import com.guardian.gameserver.model.actor.instance.L2GrandBossInstance;
import com.guardian.gameserver.model.actor.instance.L2GuardInstance;
import com.guardian.gameserver.model.actor.instance.L2ItemInstance;
import com.guardian.gameserver.model.actor.instance.L2MinionInstance;
...
import com.guardian.gameserver.model.actor.instance.L2NpcWalkerInstance;
import com.guardian.gameserver.model.actor.instance.L2PcInstance;
import com.guardian.gameserver.model.actor.instance.L2PcInstance.SkillDat;
...
import com.guardian.gameserver.model.actor.instance.L2RaidBossInstance;
import com.guardian.gameserver.model.actor.instance.L2RiftInvaderInstance;
import com.guardian.gameserver.model.actor.instance.L2SiegeFlagInstance;
import com.guardian.gameserver.model.actor.instance.L2SummonInstance;
import com.guardian.gameserver.model.actor.knownlist.CharKnownList;
import com.guardian.gameserver.model.actor.knownlist.ObjectKnownList.KnownListAsynchronousUpdateTask;
import com.guardian.gameserver.model.actor.position.L2CharPosition;
import com.guardian.gameserver.model.actor.position.ObjectPosition;
import com.guardian.gameserver.model.actor.stat.CharStat;
import com.guardian.gameserver.model.actor.status.CharStatus;
...
import com.guardian.gameserver.model.zone.type.L2BossZone;
...
import com.guardian.gameserver.network.serverpackets.Attack;
import com.guardian.gameserver.network.serverpackets.BeginRotation;
import com.guardian.gameserver.network.serverpackets.ChangeMoveType;
...
import com.guardian.gameserver.network.serverpackets.CharMoveToLocation;
import com.guardian.gameserver.network.serverpackets.ExOlympiadSpelledInfo;
import com.guardian.gameserver.network.serverpackets.L2GameServerPacket;
import com.guardian.gameserver.network.serverpackets.MagicEffectIcons;
import com.guardian.gameserver.network.serverpackets.MagicSkillCanceld;
import com.guardian.gameserver.network.serverpackets.MagicSkillLaunched;
...
import com.guardian.gameserver.network.serverpackets.PartySpelled;
import com.guardian.gameserver.network.serverpackets.PetInfo;
import com.guardian.gameserver.network.serverpackets.RelationChanged;
import com.guardian.gameserver.network.serverpackets.Revive;
...
import com.guardian.gameserver.network.serverpackets.TargetUnselected;
import com.guardian.gameserver.network.serverpackets.TeleportToLocation;
import com.guardian.gameserver.network.serverpackets.ValidateLocation;
import com.guardian.gameserver.network.serverpackets.ValidateLocationInVehicle;
import com.guardian.gameserver.skills.Calculator;
...
import com.guardian.gameserver.skills.funcs.Func;
import com.guardian.gameserver.skills.holders.ISkillsHolder;
import com.guardian.gameserver.templates.L2CharTemplate;
...
public abstract class L2Character extends L2Object implements ISkillsHolder
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Object#onSpawn()
	 */
	@Override
	public void onSpawn()
	{
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Object#getKnownList()
	 */
	@Override
	 ...
	 * <BR>
	 * see com.guardian.gameserver.model.L2Character
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Object#toString()
	 */
	@Override
