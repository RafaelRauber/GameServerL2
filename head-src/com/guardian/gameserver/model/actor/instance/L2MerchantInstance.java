...
import com.guardian.gameserver.network.serverpackets.SellList;
import com.guardian.gameserver.network.serverpackets.StatusUpdate;
import com.guardian.gameserver.network.serverpackets.WearList;
...
public class L2MerchantInstance extends L2FolkInstance
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.actor.instance.L2NpcInstance#onActionShift(com.guardian.gameserver.network.L2GameClient)
	 */
	@Override
