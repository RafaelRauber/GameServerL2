...
import com.guardian.gameserver.ai.L2DoorAI;
...
import com.guardian.gameserver.model.L2Territory;
import com.guardian.gameserver.model.actor.knownlist.DoorKnownList;
import com.guardian.gameserver.model.actor.position.L2CharPosition;
import com.guardian.gameserver.model.actor.stat.DoorStat;
import com.guardian.gameserver.model.actor.status.DoorStatus;
import com.guardian.gameserver.model.entity.ClanHall;
import com.guardian.gameserver.model.entity.siege.Castle;
import com.guardian.gameserver.model.entity.siege.Fort;
...
import com.guardian.gameserver.network.serverpackets.DoorStatusUpdate;
...
public class L2DoorInstance extends L2Character
{
	...
	public class AIAccessor extends L2Character.AIAccessor
	{
		...
		/*
		 * (non-Javadoc)
		 * @see com.guardian.gameserver.model.L2Character.AIAccessor#getActor()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.guardian.gameserver.model.L2Character.AIAccessor#moveTo(int, int, int, int)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.guardian.gameserver.model.L2Character.AIAccessor#moveTo(int, int, int)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.guardian.gameserver.model.L2Character.AIAccessor#stopMove(com.guardian.gameserver.model.actor.position.L2CharPosition)
		 */
		@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Character#hasAI()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Character#getKnownList()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Character#getStat()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Character#getStatus()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Object#isAutoAttackable(com.guardian.gameserver.model.L2Character)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Character#updateAbnormalEffect()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Character#getActiveWeaponItem()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Character#getSecondaryWeaponInstance()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Character#getSecondaryWeaponItem()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Object#onAction(com.guardian.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Object#onActionShift(com.guardian.gameserver.network.L2GameClient)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Character#broadcastStatusUpdate()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Character#doDie(com.guardian.gameserver.model.L2Character)
	 */
	@Override
