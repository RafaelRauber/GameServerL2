...
public final class L2RaidBossInstance extends L2MonsterInstance
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Character#isRaid()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.actor.instance.L2MonsterInstance#getMaintenanceInterval()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.actor.instance.L2MonsterInstance#doDie(com.guardian.gameserver.model.L2Character)
	 */
	@Override
	public boolean doDie(final L2Character killer)
	{
		...
		if (player != null)
		{
			 if (getNpcId() == Config.IdBoss)
				 ...
				 com.guardian.gameserver.model.entity.event.BossEvent.unspawnEventBoss2();
				 if (player.getClan() == null)
				 Announcements.getInstance().gameAnnounceToAll("Lost Boss: "+getName() +" foi morto por " + player.getName());
				 else
				 Announcements.getInstance().gameAnnounceToAll("Lost Boss: "+getName() +" foi morto por " + player.getName()+ " do Clan: " + player.getClan().getName());
				 }
			if (Config.ANNOUNCE_RAIDBOS_ALIVE_KILL)
				{
				if (player.getClan() == null)
				Announcements.getInstance().gameAnnounceToAll("Raid Boss: "+getName() +" foi morto por " + player.getName());
				else
				Announcements.getInstance().gameAnnounceToAll("Raid Boss: "+getName() +" foi morto por " + player.getName()+ " do Clan: " + player.getClan().getName());
				}
