...
import com.guardian.gameserver.ai.L2NpcWalkerAI;
...
public class L2NpcWalkerInstance extends L2NpcInstance
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.actor.instance.L2NpcInstance#onSpawn()
	 */
	@Override
	public void onSpawn()
	{
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Character#getAI()
	 */
	@Override
