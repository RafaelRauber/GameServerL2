	...
	public boolean doDie(final L2Character killer)
	{
		...
		if (player != null)
		{
			if (Config.ANNOUNCE_GRANBOS_ALIVE_KILL)
				...
				Announcements.getInstance().gameAnnounceToAll("Grand Boss: "+getName() +" foi morto por " + player.getName());
				else
				Announcements.getInstance().gameAnnounceToAll("Grand Boss: "+getName() +" foi morto por " + player.getName()+ " do Clan: " + player.getClan().getName());
				}
