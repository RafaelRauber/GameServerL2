...
import static com.guardian.gameserver.ai.CtrlIntention.AI_INTENTION_ACTIVE;
...
import com.guardian.gameserver.datatables.MobGroupTable;
...
import com.guardian.gameserver.model.L2DropCategory;
import com.guardian.gameserver.model.L2DropData;
...
import com.guardian.gameserver.model.actor.knownlist.NpcKnownList;
import com.guardian.gameserver.model.actor.stat.NpcStat;
import com.guardian.gameserver.model.actor.status.NpcStatus;
...
import com.guardian.gameserver.model.entity.event.Lottery;
...
import com.guardian.gameserver.model.scripts.L2RBManager;
...
import com.guardian.gameserver.network.serverpackets.ExShowVariationCancelWindow;
import com.guardian.gameserver.network.serverpackets.ExShowVariationMakeWindow;
...
import com.guardian.gameserver.network.serverpackets.RadarControl;
...
import com.guardian.gameserver.powerpak.Buffer.L2BufferInstance;
import com.guardian.gameserver.skills.Stats;
import com.guardian.gameserver.taskmanager.DecayTaskManager;
import com.guardian.gameserver.templates.L2HelperBuff;
...
public class L2NpcInstance extends L2Character
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.L2Object#isAttackable()
	 */
	@Override
	...
	public void showChatWindow(final L2PcInstance player, final int val)
	{
		...
		html.replace("%playername%", player.getName());
				if(this instanceof L2VoteSystemGlobalInstance){
					//Show TotalVotes !!OPTIONAL!!
					html.replace("%totalVotes%", VoteSystem.getInstance().getTotalvotesCache());
					//END OPTIONAL
				}
		html.replace("%objectId%", String.valueOf(getObjectId()));
