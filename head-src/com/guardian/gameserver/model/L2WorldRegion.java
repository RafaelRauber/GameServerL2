...
import com.guardian.gameserver.model.zone.L2ZoneManager;
...
import com.guardian.util.object.L2ObjectSet;
			...
			for (final L2Object o : _visibleObjects)
			{
				if (o instanceof L2Attackable)
				{
					...
					if (mob.getAI() != null)
					{
						...
						mob.getAI().setIntention(com.guardian.gameserver.ai.CtrlIntention.AI_INTENTION_IDLE);
