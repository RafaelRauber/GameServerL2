...
import com.guardian.gameserver.model.entity.event.manager.EventTask;
...
public class DM implements EventTask
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.entity.event.manager.EventTask#getEventIdentifier()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.model.entity.event.manager.EventTask#getEventStartTime()
	 */
	@Override
