 ...
 */
package com.guardian.gameserver.model.entity.event.manager;
...
public class EventManager
{
	...
	private final static String EVENT_MANAGER_CONFIGURATION_FILE = "./config/guardian/eventmanager.properties";
