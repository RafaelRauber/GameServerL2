...
public class BossEvent
{
 ...
 {
 spawnMonsterloc1();
 Announcements.getInstance().gameAnnounceToAll("O boss nasceu nas cordenadas " + Config.loc1x + "," + " " + Config.loc1y + ", " + Config.loc1z);
 Announcements.getInstance().gameAnnounceToAll(Config.dica1);
 }
 if (valor == 2)
 {
 spawnMonsterloc2();
 Announcements.getInstance().gameAnnounceToAll("O boss nasceu nas cordenadas " + Config.loc2x + "," + " " + Config.loc2y + ", " + Config.loc2z);
 Announcements.getInstance().gameAnnounceToAll(Config.dica2);
 }
 if (valor == 3)
 {
 spawnMonsterloc3();
 Announcements.getInstance().gameAnnounceToAll("O boss nasceu nas cordenadas " + Config.loc3x + "," + " " + Config.loc3y + ", " + Config.loc3z);
 Announcements.getInstance().gameAnnounceToAll(Config.dica3);
 }
 if (valor == 4)
 {
 spawnMonsterloc4();
 Announcements.getInstance().gameAnnounceToAll("O boss nasceu nas cordenadas " + Config.loc4x + "," + " " + Config.loc4y + ", " + Config.loc4z);
 Announcements.getInstance().gameAnnounceToAll(Config.dica4);
 }
 if (valor == 5)
 {
 spawnMonsterloc5();
 Announcements.getInstance().gameAnnounceToAll("O boss nasceu nas cordenadas " + Config.loc5x + "," + " " + Config.loc5y + ", " + Config.loc5z);
 Announcements.getInstance().gameAnnounceToAll(Config.dica5);
 }
 if (valor == 6)
 {
 spawnMonsterloc6();
 Announcements.getInstance().gameAnnounceToAll("O boss nasceu nas cordenadas " + Config.loc6x + "," + " " + Config.loc6y + ", " + Config.loc6z);
 Announcements.getInstance().gameAnnounceToAll(Config.dica6);
 }
 if (valor == 7)
 {
 spawnMonsterloc7();
 Announcements.getInstance().gameAnnounceToAll("O boss nasceu nas cordenadas " + Config.loc7x + "," + " " + Config.loc7y + ", " + Config.loc7z);
 Announcements.getInstance().gameAnnounceToAll(Config.dica7);
 }
 if (valor == 8)
 {
 spawnMonsterloc8();
 Announcements.getInstance().gameAnnounceToAll("O boss nasceu nas cordenadas " + Config.loc8x + "," + " " + Config.loc8y + ", " + Config.loc8z);
 Announcements.getInstance().gameAnnounceToAll(Config.dica8);
 }
 if (valor == 9)
 {
 spawnMonsterloc9();
 Announcements.getInstance().gameAnnounceToAll("O boss nasceu nas cordenadas " + Config.loc9x + "," + " " + Config.loc9y + ", " + Config.loc9z);
 Announcements.getInstance().gameAnnounceToAll(Config.dica9);
 }
 if (valor == 10)
 {
 spawnMonsterloc10();
 Announcements.getInstance().gameAnnounceToAll("O boss nasceu nas cordenadas " + Config.loc10x + "," + " " + Config.loc10y + ", " + Config.loc10z);
 Announcements.getInstance().gameAnnounceToAll(Config.dica10);
 }
 Announcements.getInstance().gameAnnounceToAll("Voce tem "+Config.time_unrespawn+" Minutos para achar e matar o boss");
 try
 {
 ...
 Announcements.getInstance().gameAnnounceToAll("Fim do Evento Lost Boss");
 unspawnEventBoss();
 }
 ...
 _bossSpawn.getLastSpawn().deleteMe();
 _bossSpawn.stopRespawn();
 Announcements.getInstance().gameAnnounceToAll("Lost Boss: Evento Encerrado, o Boss foi encontrado e morto.");
 SpawnTable.getInstance().deleteSpawn(_bossSpawn, true);
 }
