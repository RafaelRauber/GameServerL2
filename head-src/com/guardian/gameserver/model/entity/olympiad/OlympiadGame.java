 ...
 */
package com.guardian.gameserver.model.entity.olympiad;
...
import com.guardian.gameserver.model.actor.instance.L2TamedBeastInstance;
import com.guardian.gameserver.model.entity.olympiad.Olympiad.COMP_TYPE;
	...
	protected void removals()
	{
		...
		for (final L2PcInstance player : _players)
		{
			try
			{
				...
				// Remove Buffs
				if (Config.ENABLE_BUFF_OLYMPIAD)
				{
