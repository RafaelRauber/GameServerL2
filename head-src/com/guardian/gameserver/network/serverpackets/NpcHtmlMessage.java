...
import com.guardian.gameserver.network.clientpackets.RequestBypassToServer;
...
public class NpcHtmlMessage extends L2GameServerPacket
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.guardian.gameserver.network.serverpackets.L2GameServerPacket#runImpl()
	 */
	@Override
	public void runImpl()
	{
