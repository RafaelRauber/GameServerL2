...
import com.guardian.gameserver.network.serverpackets.PrivateStoreManageListSell;
...
public class SetPrivateStoreListSell extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(Config.MIN_PVP_TO_USE_STORE != 0 || Config.MIN_PK_TO_USE_STORE != 0)
		 ...
		 {
		 player.sendMessage("Voce precisa de " + Config.MIN_PVP_TO_USE_STORE + " PvP Kills para abrir uma Loja.");
		 ...
		 {
		 player.sendMessage("Voce precisa de " + Config.MIN_PK_TO_USE_STORE + " PK Kills para abrir uma Loja.");
		 player.setPrivateStoreType(L2PcInstance.STORE_PRIVATE_NONE);
		 player.broadcastUserInfo();
		 return;
		 }
